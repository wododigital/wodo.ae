...
function HeroSection() {
  ...
  const [cursorPosition, setCursorPosition] = useState({
    transform:
      "translateX(49.03194578896418px) translateY(-6.599788806758184px)",
  });
  const onMouseMove = (e) => {
    // e * t / 100
    setCursorPosition({
      transform:
        "translateX(" +
        (49.03194578896418 * e.screenY) / 600 +
        "px) translateY(" +
        (-6.599788806758184 * e.screenY) / 600 +
        "px)",
    });
  };
        ...
        >
          <div className="container">
            <div className="row mt-5" style={{ height: "80vh" }}>
              <div
                className="col-md verticle_center_heroSection_left py-3 order-3 order-md-2"
                style={{ position: "relative" }}
              >
                <span className="gf_h1">Your Digital Wingman</span>
                <p className="gf_text pt-2" style={{ color: "#FFFFFF99" }}>
                  Crafting Buzz, Igniting Growth: <br />
                  Where Brands Dare to Be Iconic!
                </p>
                <br />
                <br />
                <ElementorButton
                ...
                >
                  ...
                  <Link
                    className="social-icon"
                    to="https://www.linkedin.com/company/wodo-digital"
                    target="_blank"
                  >
              ...
              <div
                className="col-md verticle_center_heroSection_right order-2 order-md-3"
                style={{ position: "relative" }}
                id="anime_test"
              >
                {/* <div className='FlipBox FlipBox_position_1'>
                            Test 1
                        </div>

                        <div className='FlipBox FlipBox_position_2'>
                            Test 2
                        </div>

                        <div className='FlipBox FlipBox_position_3'>
                            Test 3
                        </div> */}

                <div className="flip-box FlipBox_position_1 ">
                  <div className="flip-box-inner">
                    <div className="flip-box-front verticle_center">
                      <span className="flipbox-num">50+</span>
                      <span className="flipbox-text">Industry Best Tools</span>
                    </div>
                    <div className="flip-box-back verticle_center">
                      <span className="flipbox-num">200+</span>
                      <span className="flipbox-text">Development Projects </span>
                    </div>
                  </div>
                </div>

                <div className="flip-box FlipBox_position_2 ">
                  <div className="flip-box-inner">
                    <div className="flip-box-front verticle_center">
                      <span className="flipbox-num">500M</span>
                      <span className="flipbox-text">Reach Campaign</span>
                    </div>
                    <div className="flip-box-back verticle_center">
                      <span className="flipbox-num">31%</span>
                      <span className="flipbox-text">
                ...
                <div className="flip-box FlipBox_position_3 ">
                  <div className="flip-box-inner">
                    <div className="flip-box-front verticle_center">
                      <span className="flipbox-num">6x</span>
                ...
                <div className="animation-wrapper ">
                  <div className="sphere-animation">
                    ...
                    {/* <img loading="lazy" decoding="async" width="914" height="42" src="https://wodo.digital/wp-content/uploads/2022/03/WODO-Banner-Shadow.png" className="attachment-large size-large wp-image-5554 entered lazyloaded" alt="Digital Marketing Agency For Startups" data-lazy-srcset="https://wodo.digital/wp-content/uploads/2022/03/WODO-Banner-Shadow.png 914w, https://wodo.digital/wp-content/uploads/2022/03/WODO-Banner-Shadow-768x35.png 768w" data-lazy-sizes="(max-width: 914px) 100vw, 914px" title="Digital Marketing Agency For Startups" data-lazy-src="https://wodo.digital/wp-content/uploads/2022/03/WODO-Banner-Shadow.png" data-ll-status="loaded" sizes="(max-width: 914px) 100vw, 914px" srcset="https://wodo.digital/wp-content/uploads/2022/03/WODO-Banner-Shadow.png 914w, https://wodo.digital/wp-content/uploads/2022/03/WODO-Banner-Shadow-768x35.png 768w"></img> */}
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div className="glow_circle_2" style={{ ...cursorPosition }}></div>
        </div>
        <div className="glow_circle_1" style={{ ...cursorPosition }}></div>
      </section>
    </>
  );
}
